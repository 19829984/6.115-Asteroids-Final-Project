...
void LCD_X_Config(void) {
  ...
  //
  PortAPI.pfwrite8_command = write8_command;
  PortAPI.pfwrite8_data = write8_data;
  PortAPI.pfwriteM8_data = writeM8_data;
  PortAPI.pfRead8_A1 = read8_a1;
  PortAPI.pfReadM8_A1 = readM8_a1;
